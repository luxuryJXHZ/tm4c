...
void ADC_init_SS3(){	
	...
	GPIOPinTypeADC(PE,P_2);
	GPIOPinTypeADC(PE,P_3);
	GPIOPinTypeADC(PE,P_5);
	ADCSequenceEnable(ADC1_BASE,3);
}
//**************************************************************************************
//函数名:ADC_SS0_SET
//功能说明：设置采集模式为SS0,使用专家模式触发
...
//*************************************************************************************//**************************************************************************************
//函数名:ADC_SS1_SET
//功能说明：设置采集模式为SS1，使用专家模式触发
//形参：uint32_t ui32Config（串口号）
//返回值：无
//**************************************************************************************	
void ADC_SS1_SET(uint32_t ui32Trigger,uint32_t ui32Config)
{	
	ADCSequenceConfigure(ADC1_BASE,1,ui32Trigger,0);
...
//**************************************************************************************
//函数名:ADC_SS2_SET
//功能说明：设置采集模式为SS2，使用专家模式触发
//形参：uint32_t ui32Config（串口号）
//返回值：无
//**************************************************************************************	
void ADC_SS2_SET(uint32_t ui32Trigger,uint32_t ui32Config)
{	
	ADCSequenceConfigure(ADC1_BASE,2,ui32Trigger,0);
...
//**************************************************************************************
//函数名:ADC_SS3_SET
//功能说明：设置采集模式为SS3，使用专家模式触发
//形参：uint32_t ui32Config（串口号）
//返回值：无
//**************************************************************************************	
void ADC_SS3_SET(uint32_t ui32Trigger,uint32_t ui32Config)
{	
	ADCSequenceConfigure(ADC1_BASE,3,ui32Trigger,0);
	ADCSequenceStepConfigure(ADC1_BASE,3,0,ui32Config);
